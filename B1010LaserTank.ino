...
// pin assignments
    ...
    #define LASECENTERLR 1500
#endif
#ifndef LASEMAXUD
    // the maximum up position
    #define LASEMAXUD 900
#endif
...
void loop()
{
  ...
  if(socketClient.connected()) 
  {
    ...
    if(Backgroundinit == true) {
        ...
        Sprintln("Websocket Flushed");

        // flush the serial1 port - Arduion to Arduino comms
        while(Serial1.available()) {
            char ch = Serial1.read();
        }
        Sprintln("Serial Port 1 Flushed");
      
        Sprintln("Background Init Complete");
    }
    
    // Backbground Process 1
